...
<body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <!-- Formulario único para registro -->
                <form action="registro" method="post">
                    ...
                    <fieldset class="mb-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="correoUsuario" name="correoUsuario" placeholder="Ingrese correo" required>
                        </div>
                        <div class="mb-3">
                ...
                <p class="text-center mt-3">¿Ya tienes cuenta? <a href="${pageContext.request.contextPath}/login">Inicia sesión aquí</a></p>
            </div>
        </div>
    </div>

    <!-- Modal de éxito -->
    <c:if test="${not empty registroExitoso and registroExitoso}">
    ...
    <!-- Iniciar modal automáticamente si el registro fue exitoso -->
    <c:if test="${not empty registroExitoso and registroExitoso}">
        <script>
            // Esperar a que el DOM esté listo y luego mostrar el modal
